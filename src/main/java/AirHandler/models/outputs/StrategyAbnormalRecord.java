package AirHandler.models.outputs;
...
public class StrategyAbnormalRecord {
     ...
     */
    public StrategyAbnormalRecord(long timeStamp, String type, String system, String sensorKey, String strategy, String message) {
    ...
    public void SetOriginData(JSONObject originalData) {
